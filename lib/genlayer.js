...
const STUDIO_RPC = process.env.NEXT_PUBLIC_GENLAYER_RPC_URL || 'https://studio.genlayer.com/api';
...
const CURRENT_NETWORK = process.env.NEXT_PUBLIC_GENLAYER_NETWORK || 'studionet';

export const networkConfig = NETWORKS[CURRENT_NETWORK];

export const CONTRACT_ADDRESS = '0x6A1167811763d19542396687a3d7BE5A2CC2F9c2';
